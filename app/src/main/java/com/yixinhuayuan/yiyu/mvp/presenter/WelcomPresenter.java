 ...
 */
@FragmentScope
public class WelcomPresenter extends BasePresenter<WelcomContract.Model, WelcomContract.View> {
    @Inject
    ...
    @Inject
    public WelcomPresenter(WelcomContract.Model model, WelcomContract.View rootView) {
